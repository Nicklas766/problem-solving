...
const printTowerState = () => console.log(towersStacks);

const towers = (n, from, to, spare) => {

    if (n === 1) {
        const val = towersStacks[from].pop();
        towersStacks[to].push(val);
        printTowerState();
    } else {
...
printTowerState();
towers(towersStacks[0].length, 0, 2, 1);